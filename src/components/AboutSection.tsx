    ...
    <section id="about" ref={sectionRef} className="py-24 bg-white">
      <div className="section-container">
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-1/2 opacity-0 animate-slide-right" style={{ animationDelay: '0.5s' }}>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-12 opacity-0 animate-slide-up" style={{ animationDelay: '0.6s' }}>
          <div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-burgundy">Designworks Inc. • 2020 - Present</p>
              ...
              <div>
                ...
                <p className="text-burgundy">Web Solutions • 2018 - 2020</p>
